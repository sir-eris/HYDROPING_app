...
//        }
    ...
    func sendCredentialsToESP() async {
        ...
        showWifiForm = false
        withAnimation {
            statusMessage = "Connecting your probe to the web..."
        }
...
//                }
                ...
                withAnimation {
                    statusMessage = "Connecting probe to the web faced an issue..."
                }
                return
            }
            ...
            withAnimation {
                statusStep = "3"
                statusMessage = "Successfully connected your probe to the web."
            }
